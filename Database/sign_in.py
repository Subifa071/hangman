...
def register():
    ...
    confrimpassword_label = Label(screen1, bg='white', fg='#FF7F00', text='Confirm Password',
...
def main_screen():
    ...
    register_button = Button(Title_frame, image=bg2, height="135", bg='#b7c578', borderwidth=0, width="370",
                             command=register)
