...
def gameregister():
    ...
    def main_menu_():
        ...
        score_btn = Button(root, text="Score Board", bg="bisque", font=('chocolate covered raindrops bol', 17),
                           width=25,
                           command=score_board, borderwidth=5)
        canvas.create_window(500, 210, anchor=E, window=score_btn)

        quit_btn = Button(root, text="Quit", bg="#c52626", font=('chocolate covered raindrops bol', 17), width=25,
                          fg="#f4ce5c",
                          command=quit_game, borderwidth=5)
        canvas.create_window(500, 270, anchor=E, window=quit_btn)

        sound_btn = Button(root, text="Sound", bg="#ffe599", font=('chocolate covered raindrops bol', 15), width=7,
                           command=play_music)
    ...
    def new_game():
        ...
        books_btn = Checkbutton(new_game_window, text="Books", font=('chocolate covered raindrops bol', 15),
                                variable=var1,
                                onvalue="b", offvalue="")
        canvas_new_game.create_window(340, 120, anchor=CENTER, window=books_btn)
        games_btn = Checkbutton(new_game_window, text="Games", font=('chocolate covered raindrops bol', 15),
                                variable=var2,
                                onvalue="g", offvalue="")
        ...
        tv_btn = Checkbutton(new_game_window, text="TV-Shows", font=('chocolate covered raindrops bol', 15),
                             variable=var4,
                             onvalue="t", offvalue="")
        canvas_new_game.create_window(440, 170, anchor=CENTER, window=tv_btn)

        start_new_game_btn = Button(new_game_window, text="Start new game",
                                    font=('chocolate covered raindrops bol', 15), bg="bisque",
                                    width=15,
        ...
        back_menu_btn = Button(new_game_window, text="Back", font=('chocolate covered raindrops bol', 15), width=15,
                               bg="bisque",
        ...
        quit_game_btn = Button(new_game_window, text="Quit game", font=('chocolate covered raindrops bol', 15),
                               width=15, bg="#c52626", fg="#f4ce5c",
                               command=quit_game, borderwidth=5)
    ...
    def assistance():
        ...
        if word_change == 0 and letter_change == 0:
            ...
            option_lbl = Label(option_window, text=option_text, font=('chocolate covered raindrops bol', 15),
                               bg="bisque")
    ...
    def play(hidden, word, count):
        ...
        back_menu_btn_ = Button(play_window, text="Main Menu", bg="#c52626",
                                font=('chocolate covered raindrops bol', 15), borderwidth=5, fg="#f4ce5c",
                                width=15,
        ...
        assistance_btn = Button(play_window, text="Other options", bg="#a2c4c9",
                                font=('chocolate covered raindrops bol', 15), width=15,
                                borderwidth=5, command=assistance)
        canvas_play.create_window(4, 38, anchor=SW, window=assistance_btn)

        input_answer = Button(play_window, text="Confirm", bg="#ffd967", font=('chocolate covered raindrops bol', 15),
                              command=my_answer,
                              borderwidth=5)
        canvas_play.create_window(430, 250, anchor=CENTER, window=input_answer)

        sound_btn = Button(play_window, text="Sound", bg="#a2c4c9", font=('chocolate covered raindrops bol', 15),
                           width=6,
                           command=play_music)
